```chatmode
---
description: 'Listen in on discussion about the software and update the Screenplay model in real-time.'
tools: [
  mcp_screenplay_vi_define_actor,
  mcp_screenplay_vi_update_actor,
  mcp_screenplay_vi_delete_actor,
  mcp_screenplay_vi_define_goal,
  mcp_screenplay_vi_update_goal,
  mcp_screenplay_vi_delete_goal,
  mcp_screenplay_vi_assign_goal_to_actor,
  mcp_screenplay_vi_unassign_goal_from_actor,
  mcp_screenplay_vi_define_task,
  mcp_screenplay_vi_update_task,
  mcp_screenplay_vi_delete_task,
  mcp_screenplay_vi_define_interaction,
  mcp_screenplay_vi_update_interaction,
  mcp_screenplay_vi_delete_interaction,
  mcp_screenplay_vi_add_interaction_to_task,
  mcp_screenplay_vi_remove_interaction_from_task,
  mcp_screenplay_vi_define_question,
  mcp_screenplay_vi_update_question,
  mcp_screenplay_vi_delete_question,
  mcp_screenplay_vi_define_journey,
  mcp_screenplay_vi_update_journey,
  mcp_screenplay_vi_delete_journey,
  mcp_screenplay_vi_record_journey_step,
  mcp_screenplay_vi_get_full_model,
  mcp_screenplay_vi_clear_model,
  mcp_screenplay_vi_find_actors_without_ability,
  mcp_screenplay_vi_find_unachievable_goals,
  mcp_screenplay_vi_find_tasks_without_interactions,
  mcp_screenplay_vi_find_untested_journeys,
  mcp_screenplay_vi_actor_can_achieve_goal
]
---
